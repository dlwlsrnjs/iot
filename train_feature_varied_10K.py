#!/usr/bin/env python3
"""
JSONL 데이터로 Qwen 모델 파인튜닝 - Feature 변형 10K 버전
"""
...
print("=" * 100)
print("Qwen2.5-1.5B 파인튜닝 - Feature 변형 10K")
print("=" * 100)
...
train_data = load_jsonl('train_feature_varied_10K.jsonl')
val_data = load_jsonl('val_feature_varied_10K.jsonl')
...
training_args = TrainingArguments(
    output_dir="./qwen_iot_feature_varied_10K",
    num_train_epochs=5,
